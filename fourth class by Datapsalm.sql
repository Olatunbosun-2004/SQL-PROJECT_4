...
SELECT * FROM course_Table LEFT JOIN Professor_Table ON course_Table.CoursesID = Professor_Table.ProfessorID

-- Join the course and student table such that none of the tables have a null value
SELECT * FROM course_Table INNER JOIN Student_table ON course_Table.CoursesID = Student_table.StudentID

---Join all three tables regardless of Null Values
SELECT * FROM Professor_Table
...
---Join all professor and course table regardless of the null value
SELECT * FROM Professor_Table
FULL OUTER JOIN course_Table ON course_Table.CoursesID = Professor_Table.ProfessorID

---Join the three column such that none of them have a null value
SELECT * FROM Professor_Table
